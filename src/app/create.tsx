...
export default function CreateCardScreen() {
    ...
    const { control, handleSubmit, formState: { errors } } = useForm({
        ...
        defaultValues: { name: '', title: '', company: '', phone: '', email: '', website: '', profileImage: '', companyLogo: '' }
    });
    ...
    const onSubmit = (data: any) => {
        const newCard: BusinessCard = {
            ...
            theme: 'default', template: 'corporate',
        ...
        <ScrollView className="flex-1 bg-white dark:bg-gray-900 p-4">
            <View className="gap-y-4 pb-12">
                ...
                <Pressable
                    ...
                    className="bg-blue-600 rounded-xl py-4 items-center mt-6 shadow-sm active:opacity-80"
                >
                    <Text className="text-white font-semibold text-lg">Save Card</Text>
                </Pressable>
            </View>
        </ScrollView>
    );
